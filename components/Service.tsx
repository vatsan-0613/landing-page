    ...
    return (
        <section className={`${flex} max-sm:flex-col-reverse items-center flex mt-16 w-full px-10 justify-between mb-16`}>
            <div className='sm:w-[50%] text-center'>
                <h2 className='md:text-5xl  sm:text-3xl text-2xl font-semibold mb-5 sm:leading-tight mt-5 sm:mt-0 text-center sm:text-start'><span className='text-buttonOrange'>Unleash</span> the power of AI with GenAI</h2>
                <p className='text-smallText sm-leading-8 leading-6 sm:text-md text-sm text-center sm:text-start'>
